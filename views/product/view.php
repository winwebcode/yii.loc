                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            <?php if ($product->new === '1') {
                                echo Html::img("@web/images/product-details/new.jpg", ['alt'=> '', 'class' => 'newarrival']);
                            }
                            if ($product->sale === '1') {
                            echo Html::img("@web/images/home/sale.png", ['alt'=> 'Sale', 'class' => 'newarrival']);
                            }
                            ?>
                ...
                <div class="recommended_items"><!--recommended_items-->
                    ...
                    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            foreach ($hits as $hit): ?>
                            <!--кратно 3 добавляем класс active-->
                                            ...
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        ...
                                                        <h2><?= $product->price;?></h2>
                                                        <a href="<?= Url::to(['product/view', 'id' => $hit->id])?>"><?= $product->name;?>
                                                        <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <?php $i++; if ($i % 3 == 0) : ?>
                                    <!--кратно 3 закрываем данный блок-->
                                    </div>
                                <?php endif; ?>
                            <?php endforeach;?>
                        </div>
